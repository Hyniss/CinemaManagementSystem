...
@WebServlet(name = "AdminDeleteMovieController", urlPatterns = {"/deletemovie"})
public class AdminDeleteMovieController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int movieId=Integer.parseInt(request.getParameter("movieID"));//lay ra movie id tu request
