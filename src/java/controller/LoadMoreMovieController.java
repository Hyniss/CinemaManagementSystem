        ...
        try (PrintWriter out = response.getWriter()) {
            for (Movie o : movieList) {
                out.println("<div class=\"movie col-md-3 mt-4\" >\n"
                        ...
                        + "                            <a href=\"movie?mid=" +o.getMovieId()+ "\"><img src=\"././././assets/img/movie/" + o.getImage() + "\" class=\"aa-product-img shadow border-radius-lg card-header\" position=\"absolute\" top=\"0\" left=\"0\" display=\"block\" width=\"100%\" height=\"500px\" margin-bottom =\"20px\" object-fit= \"cover\" alt=\"...\"></a>\n"
                        + "                            <div class=\"card-body\">\n"
                        ...
                        + "                                    <h4 class=\"currency price-hp\" style=\"color: #000\">Khởi chiếu: " + o.getPremiere() + "</h4> \n"
                        + "                                </div>\n"
