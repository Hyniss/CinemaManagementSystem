 ...
 * /AddListTime is the URL of the web site Extend HttpServlet
 * class
 *
 * @author Nguyen Nam
 */
        ...
        if (slot != null) {
            for (int i = 0; i < slot.length; i++) {
                if (slot[i].equals("1")) {
                    ...
                    add=movieTimeDAO.addMovieTime("slot1", start, end, movieRoomId, "yes");
                    if (i < slot.length - 1) {
                        i++;
                    }
                } else {
                    ...
                    add=movieTimeDAO.addMovieTime("slot1", start, end, movieRoomId, "no");
                }
                if (slot[i].equals("2")) {
                    start = Time.valueOf("10:10:00");
                    end = Time.valueOf("12:10:00");
                    add=movieTimeDAO.addMovieTime("slot2", start, end, movieRoomId, "yes");
                    if (i < slot.length - 1) {
                        i++;
                    }
                } else {
                    ...
                    add=movieTimeDAO.addMovieTime("slot2", start, end, movieRoomId, "no");
                }
                if (slot[i].equals("3")) {
                    start = Time.valueOf("12:20:00");
                    end = Time.valueOf("14:20:00");
                    add=movieTimeDAO.addMovieTime("slot3", start, end, movieRoomId, "yes");
                    ...
                    add=movieTimeDAO.addMovieTime("slot3", start, end, movieRoomId, "no");
                }
                if (slot[i].equals("4")) {
                    start = Time.valueOf("14:30:00");
                    end = Time.valueOf("16:30:00");
                    add=movieTimeDAO.addMovieTime("slot4", start, end, movieRoomId, "yes");
                    if (i < slot.length - 1) {
                        i++;
                    }
                } else {
                    ...
                    add=movieTimeDAO.addMovieTime("slot4", start, end, movieRoomId, "no");
                }
                if (slot[i].equals("5")) {
                    start = Time.valueOf("16:40:00");
                    end = Time.valueOf("18:40:00");
                    add=movieTimeDAO.addMovieTime("slot5", start, end, movieRoomId, "yes");
                    if (i < slot.length - 1) {
                        i++;
                    }
                } else {
                    ...
                    add=movieTimeDAO.addMovieTime("slot5", start, end, movieRoomId, "no");
                }
                if (slot[i].equals("6")) {
                    start = Time.valueOf("18:50:00");
                    end = Time.valueOf("20:50:00");
                    add=movieTimeDAO.addMovieTime("slot6", start, end, movieRoomId, "yes");
                    if (i < slot.length - 1) {
                        i++;
                    }
                } else {
                    ...
                    add=movieTimeDAO.addMovieTime("slot6", start, end, movieRoomId, "no");
                }
                break;
            }
        } else {
