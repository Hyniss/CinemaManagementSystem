                                            ...
                                            <td style="margin: 1px">
                                                <ul class="products-grid-movie tab-showtime" style="margin-bottom: 5px; list-style: none;
                                                    ...
                                                    <ul class="item" style="    border: 1px solid #222;
                                                        ...
                                                        <a class="dropdown-item2" href="${pageContext.request.contextPath}/seat?movieRoomId=${movieRoomId}&roomId=${p.roomId}&movieId=${movieId}&time=${i.timeId}" style="color: #e71a0f;
