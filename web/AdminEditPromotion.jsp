                        ...
                        <form action="edit_promotion" method="post">
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <img class="rounded" height="20%" width="30%" id="image" src="${pageContext.request.contextPath}/assets/img/promotion/${promotion.imageLink}" />
                                    <div id="myfileupload">
                                        <input value="${pageContext.request.contextPath}/assets/img/promotion/${promotion.imageLink}" type="file" name="new_img" id="uploadfile" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
                                ...
                                <div class="form-group">
                                    <label>Coupon<span style="color:red;"> *</span></label>
