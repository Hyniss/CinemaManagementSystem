                        ...
                        <form action="edit_banner" method="post">
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <img class="rounded" height="20%" width="30%" id="image" src="${pageContext.request.contextPath}/assets/img/banner/${banner.img}" />
                                    <div id="myfileupload">
                                        <input value="${pageContext.request.contextPath}/assets/img/banner/${banner.img}" type="file" name="new_Img" id="uploadfile" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
