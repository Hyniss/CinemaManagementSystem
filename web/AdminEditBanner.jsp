                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="${pageContext.request.contextPath}/edit_banner" method="post">
                                <div class="form-group">
                                    <label for="input-1">ID</label>
                                    <input type="text" class="form-control" readonly id="input-1" placeholder="ID" value="${banner.id}" name="new_id">
                                </div>
                                <div class="form-group">
                                    <label for="input-2">Title</label>
                                    <input type="text" class="form-control" id="input-2" placeholder="Update Title ..." value="${banner.title}"name="new_title">
                                </div>
                                <div class="form-group">
                                    <label for="input-2">Image</label>
                                    <input type="text" class="form-control" id="input-10" placeholder="The direct of Image" value="${banner.img}"name="new_Img">
                                </div>
                                <div class="form-group">
