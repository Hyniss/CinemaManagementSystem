                        ...
                        <form action="add_promotion" method="post">
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <div id="myfileupload">
                                        <input value="${pageContext.request.contextPath}/assets/img/promotion/${promotion.imageLink}" type="file" id="uploadfile" name="new_imageLink" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
