                                        ...
                                        <tbody>
                                            <c:forEach items="${cvInforList}" var="cvInforList">
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><img id="image" style="object-fit: cover; height: 50%; width: 100%; text-align: center" src="${pageContext.request.contextPath}/assets/img/CV/${cvInforList.CV}" onclick="zoom()"  ></td>
