<%-- 
    ...
    Created on : Mar 11, 2022, 12:13:31 AM
    Author     : HP
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5">
                            <div class="img-container">
                                <img src="${pageContext.request.contextPath}/assets/img/notification/${notification.notificationImg}" alt="" class="img-full">
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7">
                            ...
                            <div class="member_desc">
                                <ul class="styled_list">
                                    <li class=""><i class="fa fa-chevron-circle-right" aria-hidden="true"></i>   Ngày thông báo:
                                        <fmt:formatDate pattern="dd-MM-yyyy" value = "${notification.notificationDate}"/>
                                    </li>
                                </ul>
                            </div>
                            <div class="member_desc">
                                <h4 style="font-weight: bold">Chi tiết</h4>
                                <p>
