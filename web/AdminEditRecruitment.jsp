                        ...
                        <form action="edit_recruitment" method="post">
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <img class="rounded" height="20%" width="30%" id="image" src="${pageContext.request.contextPath}/assets/img/recruitment/${recruitment.img}" />
                                    <div id="myfileupload">
                                        <input value="${pageContext.request.contextPath}/assets/img/recruitment/${recruitment.img}" type="file" name="new_img" id="uploadfile" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
