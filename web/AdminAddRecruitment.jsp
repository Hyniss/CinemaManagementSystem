        ...
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title" style="margin: 10px; color: #ffffff">Add Recruitment</div>
                            <form action="add_recruitment" method="post">
                                ...
                                <div class="form-footer" style="margin-top: 10px">
                                    ...
                                    <button class="btn btn-danger"><i class="fa fa-times"></i><a href="${pageContext.request.contextPath}/adminrecruitmentlist">Cancel</a></button>
                                </div>
                            </form>
                        </div>
                    </div>
