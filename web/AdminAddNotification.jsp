                        ...
                        <form action="adminnotificationadd" method="post">
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <div id="myfileupload">
                                        <input value="${pageContext.request.contextPath}/assets/img/notification/${notification.notificationImg}" type="file" id="uploadfile" name="img" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
