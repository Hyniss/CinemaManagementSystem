                    ...
                    <div class="modal-content">
                        ...
                        <form action="adminnotificationedit" method="post">
                            <div class="modal-body">
                                ...
                                <div>
                                    <p class="text-muted">Notification Image<span style="color:red;"> *</span></p>
                                    <img class="rounded" height="20%" width="30%" id="image" src="${pageContext.request.contextPath}/assets/img/notification/${notification.notificationImg}" />
                                    <div id="myfileupload">
                                        <input value="${pageContext.request.contextPath}/assets/img/notification/${notification.notificationImg}" type="file" name="img" id="uploadfile" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
